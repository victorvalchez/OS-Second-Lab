...
echo "MSH>>[OK] 10 % 7 = 3; Quotient 1"   >>calc3.res
echo "MSH>>"                              >>calc3.res

echo "mycalc 10 pp 7"                 >calc4
echo "MSH>>[ERROR] The structure of the command is mycalc <operand_1> <add/mod> <operand_2>"  >calc4.res
echo "MSH>>"                              																	 >>calc4.res
echo "mycalc mycalc 8 mas"            >calc5
echo "MSH>>[ERROR] The structure of the command is mycalc <operand_1> <add/mod> <operand_2>"  >calc5.res
echo "MSH>>"                              																	 >>calc5.res


#mycp
echo "mycp"								     >bak1
echo "[ERROR] The structure of the command is mycp <original_file> <copied_file>" >bak1.res
echo "mycp noexiste.txt ."				  >bak2
echo "[ERROR] Error opening original file" >bak2.res
echo "mycp msh.c msh.c_bak"			  >bak3
echo "MSH>>[OK] Copy has been successful between msh.c and msh.c_bak" >bak3.res
echo "MSH>>" 																	       >>bak3.res
...
testeo2Error calc5 calc5.res
echo -n "Test19: Calculator \$Acc -> "
testeoCalc
